...
public class MainActivityTabbed extends Activity implements ActionBar.TabListener {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.main_activity_tabbed, menu);
        return true;
    }
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            ...
            switch (position) {
                case 0:
                    return getString(R.string.title_read).toUpperCase(l);
                case 1:
                    return getString(R.string.title_listen).toUpperCase(l);
                case 2:
                    return getString(R.string.title_watch).toUpperCase(l);
            }
            return null;
        }
    }
